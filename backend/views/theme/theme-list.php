    ...
    <table class="table" width="1200" layoutH="138">
        ...
        <?php foreach($dataList as $key => $data):?>
            <tr target="card-id" rel="<?=$data['id']?>" class="cnt">
                ...
                <td><img height="80" src="<?=ArrayHelper::getValue($data,'template_url') ? rtrim(ArrayHelper::getValue($data,'template_url'),'.tif').'.jpg' : ''?>" /></td>
                <td><?=$data['left_source_pic_name']?></td>
                <td><img height="80" src="<?=ArrayHelper::getValue($data,'left_template_url') ? rtrim(ArrayHelper::getValue($data,'left_template_url'),'.tif').'.jpg' : ''?>" /></td>
