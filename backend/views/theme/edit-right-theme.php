...
<div class="pageContent">
    <form method="post" action="<?=Url::to(['theme/edit-right-theme','id' => ArrayHelper::getValue($model,'id','')])?>" class="pageForm required-validate" onsubmit="return validateCallback(this,navTabAjaxDone)">
        <input type="hidden" id="source_pic_name" name="RightThemeModel[source_pic_name]" value="<?=ArrayHelper::getValue($model,'source_pic_name','')?>"/>
        <div class="pageFormContent nowrap" layoutH="97">
            ...
            <dl>
                <dt>条码：</dt>
                <dd>
                    <input type="text" name="RightThemeModel[barcode]" maxlength="2" minlength="2" class="required alphanumeric" value="<?=ArrayHelper::getValue($model,'barcode',$barcode)?>"/>
                    <span class="info"></span>
                </dd>
            </dl>
            <dl>
                <dt>颜色：</dt>
                <dd>
                    <input type="text" class="textInput readonly" readonly="true" name="RightThemeModel[color]" value="<?=ArrayHelper::getValue($model,'color')?>" data-name="color.name" suggestfields="name" lookupgroup="color" autocomplete="off">
            ...
            <dl>
                <dt>客户：</dt>
                <dd>
                    <input type="hidden" id="theme-customer" name="RightThemeModel[customer_id]" data-name="customer.id" value="<?=ArrayHelper::getValue($model, 'customer_id',$customer_id)?>">
            ...
            <dl>
                <dt>图案：</dt>
                <dd>
                    <input type="text" readonly="true" name="RightThemeModel[template_url]" class='template-url readonly' value="<?=ArrayHelper::getValue($model,'template_url','')?>"/>
