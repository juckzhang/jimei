    ...
    <table class="table" width="1200" layoutH="138">
        ...
        <?php foreach($dataList as $key => $data):?>
            <tr target="card-id" rel="<?=$data['id']?>">
                ...
                <td><?=$data['left']?></td>
                <td><?=$data['top']?></td>
                <td><img height="80" src="<?=rtrim($data['border_url'],'.tif').'.jpg'?>" /></td>
                <td><img height="80" src="<?=rtrim($data['left_border_url'],'.tif').'.jpg'?>" /></td>
                <td><img height="80" src="<?=rtrim($data['right_border_url'],'.tif').'.jpg'?>" /></td>
