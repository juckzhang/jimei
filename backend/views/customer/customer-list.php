            ...
            <tr target="card-id" rel="<?=$data->id?>">
                ...
                <td>
                    ...
                    <?php if(\Yii::$app->user->can('theme/theme-list')):?>
                        <a title="图案列表" target="navTab" rel="theme-list" href="<?=Url::to(['theme/theme-list', 'notMore' => 1, 'other' => ['customer_id' => $data->id],'customer-name' => urlencode($data->name)])?>" class="btnInfo">编辑</a>
                    <?php endif;?>
                </td>
                <?php endif;?>
            </tr>
