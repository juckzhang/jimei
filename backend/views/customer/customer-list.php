            ...
            <tr target="card-id" rel="<?=$data->id?>">
                ...
                <td>
                    ...
                    <?php if(\Yii::$app->user->can('meal/meal-list')):?>
                        <a title="套餐列表" target="navTab" rel="meal-list" href="<?=Url::to(['meal/meal-list', 'notMore' => 1, 'other' => ['customer_id' => $data->id],'customer-name' => urlencode($data->name)])?>" class="btnInfo">套餐列表</a>
                    <?php endif;?>
                </td>
                <?php endif;?>
            </tr>
