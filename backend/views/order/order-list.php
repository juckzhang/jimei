    ...
    <table class="table" width="200%" layoutH="138">
        ...
        <?php foreach($dataList as $key => $data):?>
            <tr target="card-id" rel="<?=$data['id']?>">
                ...
                <td><img height="50" src="<?=ArrayHelper::getValue($data,'theme.template_url') ? rtrim(ArrayHelper::getValue($data,'theme.template_url'),'.tif').'.jpg' : ''?>" /></td>
                <td><img height="50" src="<?=ArrayHelper::getValue($data,'theme.left_template_url') ? rtrim(ArrayHelper::getValue($data,'theme.left_template_url'),'.tif').'.jpg' : ''?>" /></td>
                <td><img height="50" src="<?=ArrayHelper::getValue($data,'theme.right_template_url') ? rtrim(ArrayHelper::getValue($data,'theme.right_template_url'),'.tif').'.jpg' : ''?>" /></td>
                ...
                <td><img height="50" src="<?=ArrayHelper::getValue($data,'relat.border_url') ? rtrim(ArrayHelper::getValue($data,'relat.border_url'),'.tif').'.jpg' : ''?>" /></td>
                <td><img height="50" src="<?=ArrayHelper::getValue($data,'relat.left_border_url') ? rtrim(ArrayHelper::getValue($data,'relat.left_border_url'),'.tif').'.jpg' : ''?>" /></td>
                <td><img height="50" src="<?=ArrayHelper::getValue($data,'relat.right_border_url') ? rtrim(ArrayHelper::getValue($data,'relat.right_border_url'),'.tif').'.jpg' : ''?>" /></td>
