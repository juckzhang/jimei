...
<div class="pageHeader">
    <form rel="pagerForm" onsubmit="return <?=$search ? 'dialogSearch' : 'navTabSearch'?>(this);" action="<?=Url::to(['material/material-list','search' => $search, 'more' => $more, 'notMore' => ArrayHelper::getValue($params,'notMore')])?>" method="post">
        <div class="searchBar">
